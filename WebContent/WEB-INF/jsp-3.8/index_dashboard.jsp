...
<head>
<meta charset="utf-8"/>
<title>Adogo | Admin Dashboard Template</title>
...
<link href="/admin/assets/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css"/>
...
<link href="/admin/assets/admin/layout2/css/themes/grey.css" rel="stylesheet" type="text/css" id="style_color"/>
 ...
 -->
						...
						<div class="portlet light ">
							...
							<div class="portlet-body">
								<div id="site_statistics_loading">
									<img src="/admin/assets/admin/layout2/img/loading.gif" alt="loading"/>
								</div>
										...
										<div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
											<div class="row">
												<div class="col-md-6 user-info">
													<img alt="" src="/admin/assets/admin/layout2/img/avatar.png" class="img-responsive"/>
													<div class="details">
														<div>
															<a href="javascript:;">
															Robert Nilson </a>
						...
						<div class="portlet light ">
							...
							<div class="portlet-body" id="chats">
								<div class="scroller" style="height: 353px;" data-always-visible="1" data-rail-visible1="1">
									<ul class="chats">
										<li class="in">
											<img class="avatar" alt="" src="/admin/assets/admin/layout2/img/avatar1.jpg"/>
											<div class="message">
												<span class="arrow">
												</span>
										...
										<li class="out">
											<img class="avatar" alt="" src="/admin/assets/admin/layout2/img/avatar2.jpg"/>
											<div class="message">
												<span class="arrow">
												</span>
												<a href="javascript:;" class="name">
										...
										<li class="out">
											<img class="avatar" alt="" src="/admin/assets/admin/layout2/img/avatar3.jpg"/>
											<div class="message">
												<span class="arrow">
												</span>
												<a href="javascript:;" class="name">
	...
	<div class="page-footer">
		<div class="page-footer-inner">
			 2016 &copy; Adogo &trade; by Informatique Athensoft. <a href="#" target="_blank"></a>
		</div>
