...
<link href="/admin/assets/admin/layout/css/layout.css" rel="stylesheet" type="text/css"/>
...
<script src="/admin/assets/admin/pages/scripts/login-soft.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
