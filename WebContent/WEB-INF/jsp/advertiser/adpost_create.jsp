                	...
                	<form class="form-horizontal form-row-seperated" action="#">
                    	<div class="portlet">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-shopping-cart"></i>Create an Ad Post<span class="caption-helper"> writing Ad details, associated medias, pictures, etc.</span>
								</div>
                            ...
                            <div class="portlet-body">
                                <div class="tabbable-bordered" id="tabs_event">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li><a href="#tab_images" data-toggle="tab"> Gallery </a></li>
                                    </ul>
