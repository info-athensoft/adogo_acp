...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
	...
	<div class="page-container">
        ...
        <div class="page-content">
        	<!-- BEGIN PAGE HEADER-->
            <h1 class="page-title"> Advertiser | Business <small>home</small></h1>
            <div class="page-bar">
                    	...
                    	<div class="portlet-title">
                        	...
                        	<div class="actions">
                            	<div class="btn-group btn-group-devided">
                                    ...
                                    <a href="${webapp_name}/advertiser/biz/edit.html?bizId=${bizProfile.bizId}" class="btn yellow" id="btnEdit"> Edit Profile </a>
                                </div>
                            </div>
                         </div>
                    	<div class="portlet-body">
