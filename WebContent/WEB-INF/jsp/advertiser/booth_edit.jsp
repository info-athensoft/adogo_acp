...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            <!-- PAGE HEADER-->
            <h1 class="page-title"> Advertiser | Booth <small>update my booth</small></h1>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li><span>Update a Booth</span></li>
				</ul>
                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                Update a booth <span class="caption-helper"> under ${bizProfile.bizName} </span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">
                   			...
                   			<div class="row">
                    			<span class="col-md-3 bold"> Booth ID: </span>
                    			<span class="col-md-6">${booth.boothId}</span>
                   			</div>
                   			<div class="row">
                    			<span class="col-md-3 bold"> Booth Language: </span>
                    			<span class="col-md-6">${langMapObj.getLangName(booth.langNo)}</span>
                   			</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="portlet light">
                    	<div class="portlet-title">
                            ...
                            <div class="actions">
                                <a class="btn btn-success" onclick="updateBooth(); return false;">
                            ...
                            <div class="form-horizontal" role="form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group hide">
                                        ...
                                        <div class="col-md-9">
                                            <select id="langNo" class="form-control" onchange="chooseLanguage();return false;" disabled="disabled">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="Enter text" id="langBoothName" value="${booth.bizName}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" placeholder="Choose" id="categoryNo" value="${booth.categoryNo}">
                                        </div>
                                        <div class="col-md-3">
                                	...
                                	<div class="row">
	                                	<div class="col-md-5">
                       					...
                       					<div class="col-md-7">
			                    		  	<div class="form-group">
			                              		<div class="col-md-12">
			                                  		<!--  <input type="text" id="booth-cover-img-title" class="form-control" placeholder="Image Title"> -->
			                             	...
			                             	<div class="form-group">
			                                	<div class="col-md-12">
			                                    	<input type="text" id="booth-cover-img-url" class="form-control" placeholder="Image URL" disabled="disabled" value="${booth.boothImg}">
			                                    	<input type="hidden" id="booth-cover-img-url-short" value="${booth.boothImg.substring(1+booth.boothImg.lastIndexOf('/'))}"/>
			                                	</div>
			                            	</div>
			                            	<div class="form-group">
			                                	<div class="col-md-12">
	                                	...
	                                	<div class="col-md-5">
			                       			<div class="fileinput fileinput-new" data-provides="fileinput">
			                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
			                                       	...
			                                       	<img id="fileinput-new-img_boothBanner" src="${booth.boothBanner.mediaUrl}" alt=""/>
												</div>
			                                    <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">
												</div>
			                                    <div>
                       					...
                       					<div class="col-md-7">
			                             	...
			                             	<div class="form-group">
			                                	<div class="col-md-12">
			                                    	<input type="text" id="booth-banner-img-url" class="form-control" placeholder="Image URL" disabled="disabled" value="${booth.boothBanner.mediaUrl}">
			                                	</div>
			                            	</div>
			                            	<div class="form-group">
			                                	<div class="col-md-12">
                            ...
                            <div class="form-horizontal" role="form">
                                <div class="form-body">
                                	<div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" rows="4" id="langBizDesc" placeholder="usually put your business description here and should be in the chosen language">${booth.bizDesc}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="textTitle1" placeholder="write the title here" value="${booth.boothTextList[0].textTitle}"/>
                                            <span class="help-inline"> </span>
                                        </div>
                                        <label class="col-md-3 control-label">Text Content 1</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" rows="3" id="text1" placeholder="please input brief introduction to your company or yourself here">${booth.boothTextList[0].textContent}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="textTitle2" placeholder="write the title here" value="${booth.boothTextList[1].textTitle}"/>
                                            <span class="help-inline"> </span>
                                        </div>
                                        <label class="col-md-3 control-label">Text Content 2</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" rows="3" id="text2" placeholder="please briefly list your services or products your company is providing here">${booth.boothTextList[1].textContent}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="textTitle3" placeholder="write the title here" value="${booth.boothTextList[2].textTitle}"/>
                                            <span class="help-inline"> </span>
                                        </div>
                                        <label class="col-md-3 control-label">Text Content 3</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" rows="3" id="text3" placeholder="please briefly list your strong points to other similar businesses here">${booth.boothTextList[2].textContent}</textarea>
                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-body" id="blockui_buz_hrs_id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="day1_start_time" type="text" class="form-control" placeholder="start time" value="${booth.businessHours.day1StartTime}">
                                                </div>
                                                <div class="col-md-1">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                                                </div>
                                                <div class="col-md-4">
                                                    <input id="day1_end_time" type="text" class="form-control" placeholder="end time" value="${booth.businessHours.day1EndTime}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="day2_start_time" type="text" class="form-control" placeholder="start time"  value="${booth.businessHours.day2StartTime}">
                                                </div>
                                                <div class="col-md-1">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                                                </div>
                                                <div class="col-md-4">
                                                    <input id="day2_end_time" type="text" class="form-control" placeholder="end time" value="${booth.businessHours.day2EndTime}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="day3_start_time" type="text" class="form-control" placeholder="start time" value="${booth.businessHours.day3StartTime}">
                                                </div>
                                                <div class="col-md-1">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                                                </div>
                                                <div class="col-md-4">
                                                    <input id="day3_end_time" type="text" class="form-control" placeholder="end time" value="${booth.businessHours.day3EndTime}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="day4_start_time" type="text" class="form-control" placeholder="start time"  value="${booth.businessHours.day4StartTime}">
                                                </div>
                                                <div class="col-md-1">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                                                </div>
                                                <div class="col-md-4">
                                                    <input id="day4_end_time" type="text" class="form-control" placeholder="end time" value="${booth.businessHours.day4EndTime}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="day5_start_time" type="text" class="form-control" placeholder="start time" value="${booth.businessHours.day5StartTime}">
                                                </div>
                                                <div class="col-md-1">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                                                </div>
                                                <div class="col-md-4">
                                                    <input id="day5_end_time" type="text" class="form-control" placeholder="end time" value="${booth.businessHours.day5EndTime}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="day6_start_time" type="text" class="form-control" placeholder="start time" value="${booth.businessHours.day6StartTime}">
                                                </div>
                                                <div class="col-md-1">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                                                </div>
                                                <div class="col-md-4">
                                                    <input id="day6_end_time" type="text" class="form-control" placeholder="end time" value="${booth.businessHours.day6EndTime}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="day7_start_time" type="text" class="form-control" placeholder="start time" value="${booth.businessHours.day7StartTime}">
                                                </div>
                                                <div class="col-md-1">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                                                </div>
                                                <div class="col-md-4">
                                                    <input id="day7_end_time" type="text" class="form-control" placeholder="end time" value="${booth.businessHours.day7EndTime}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea id="comment" class="form-control" rows="3" 
                                                  			placeholder="please input your announcement or reminding information about opening hours or special schedule of holidays for your clients">${booth.businessHours.comment}
                                                    </textarea>
                                                    <p>
                                                    	<br/>
...
<script type="text/javascript" src="${webapp_name}/assets/pages/scripts-local/temp/adpost-create-test.js"></script>
 ...
 <script type="text/javascript" src="${webapp_name}/assets/pages/scripts-local/advertiser/booth-edit.js"></script>
