...
<link href="${webapp_name}/assets/pages/css/login-soft.css" rel="stylesheet" type="text/css"/>
...
<link href="${webapp_name}/assets/layouts/layout2/css/layout.css" rel="stylesheet" type="text/css"/>
<link href="${webapp_name}/assets/layouts/layout2/css/themes/default.css" id="style_color" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="/login">
	<img src="${webapp_name}/assets/layouts/layout2/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<script src="${webapp_name}/assets/layouts/layout2/scripts/layout.js" type="text/javascript"></script>
<script src="${webapp_name}/assets/layouts/layout2/scripts/demo.js" type="text/javascript"></script>
<script src="${webapp_name}/assets/layouts/pages/scripts/login-soft.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
