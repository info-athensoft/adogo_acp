...
<link href="${webapp_name}/assets/pages/css/login-4.min.css" rel="stylesheet" type="text/css" />
...
<body class=" login">
	<!-- BEGIN LOGO -->
    <div class="logo">
    	<a href="index.html"><img src="${webapp_name}/assets/pages/img/logo-big.png" alt="" /></a>
    </div>
    ...
    <form class="login-form" action="index.html" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username" id="userName" value="fangze@gmail.com"/> </div>
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <div class="input-icon">
                        <i class="fa fa-lock"></i>
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" id="password" value="1"/> </div>
                </div>
                <div class="form-actions">
                    ...
                    <a class="btn green pull-right" onclick="doLogin(); return flase;"> Login </a>
                </div>
    ...
    <!-- FOOTER -->
    <div class="copyright"> 2018 &copy; ADOGO &trade;  Informatique Athensoft <a href="#" target="_blank"></a> &nbsp;&nbsp;&nbsp;All Rights Reserved </div>
    <!-- END FOOTER -->
...
<script type="text/javascript" src="${webapp_name}/assets/global/plugins/backstretch/jquery.backstretch.min.js"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script type="text/javascript" src="${webapp_name}/assets/global/scripts/app.min.js"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script type="text/javascript" src="${webapp_name}/assets/pages/scripts/login-4.js"></script>
<!-- updated login-4-min.js to login-4.js which is modified by Athens on 2017-07-16 -->
...
//	alert("userName="+userName+" @ "+"password="+password);
	...
	$.ajax({
		type	:	"get",
		url		:	"/acp/login?userName="+userName,
		dataType:	"json",
//		data	: 	{	adPostJSONString : JSON.stringify(businessObject) },
		timeout : 	5000,
		success	:	function(data){
//					alert("INFO: doLogin success");
					
					var userAccount = data.userAccount;
//					alert("User login as : "+userAccount.userName + " @ "+"password="+userAccount.password);
					
					window.location.href="/acp/index.html";
		}		
	});
}
