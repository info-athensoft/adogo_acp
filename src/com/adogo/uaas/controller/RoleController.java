...
public class RoleController {
	...
	public void setNewsService(RoleService roleService) {
	...
	private String[][] getData(List<Role> listRole, String actionName){
		int entryLength = listRole.size();
		...
		for(int i=0; i<entryLength ; i++){			
			field0 = "<input type='checkbox' name='id[]' value="+listRole.get(i).getRoleId()+">";
			field1 = listRole.get(i).getRoleId()+"";
			field2 = listRole.get(i).getRoleCode()+"";
			field3 = listRole.get(i).getRoleLevel()+"";
			field4 = listRole.get(i).getRoleType()+"";
			field5 = listRole.get(i).getRoleName();
			
			int intRoleStatus = listRole.get(i).getRoleStatus();
